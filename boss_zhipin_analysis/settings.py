"""
Django settings for boss_zhipin_analysis project.
...
SECRET_KEY = 'django-insecure-)j6ma^dp=i-^kz0ia@x$!$5cytqsz^$038tkdw5exsabq0)=n-'
...
ROOT_URLCONF = 'boss_zhipin_analysis.urls'
...
WSGI_APPLICATION = 'boss_zhipin_analysis.wsgi.application'
